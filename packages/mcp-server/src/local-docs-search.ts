...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    description:
      'Lists the profiles in the current account. Supports free-form search and a type filter, intended for member-picker UIs (e.g. choosing a profile to add to a workspace).',
    ...
    perLanguage: {
      ...
      cli: {
        method: 'profiles list',
        example: "cadenya profiles list \\\n  --api-key 'My API Key'",
      },
      http: {
        example:
          'curl https://api.cadenya.com/v1/profiles \\\n    -H "Authorization: Bearer $CADENYA_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    description: 'Creates a new workspace in the current account. Requires the admin role.',
    ...
    response:
      "{ metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }; spec: { description?: string; }; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }",
    markdown:
      "## create\n\n`client.workspaces.create(metadata: { name: string; externalId?: string; labels?: object; }, spec: { description?: string; }): { metadata: account_resource_metadata; spec: workspace_spec; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }`\n\n**post** `/v1/workspaces`\n\nCreates a new workspace in the current account. Requires the admin role.\n\n### Parameters\n\n- `metadata: { name: string; externalId?: string; labels?: object; }`\n  CreateAccountResourceMetadata contains the user-provided fields for creating\n an account-scoped resource. Read-only fields (id, account_id, profile_id) are excluded\n since they are set by the server.\n  - `name: string`\n    Human-readable name for the resource (e.g., \"Production API Key\", \"Staging Workspace\")\n  - `externalId?: string`\n    External ID for the resource (e.g., a workflow ID from an external system)\n  - `labels?: object`\n    Arbitrary key-value pairs for categorization and filtering\n Examples: {\"environment\": \"production\", \"team\": \"platform\", \"version\": \"v2\"}\n\n- `spec: { description?: string; }`\n  - `description?: string`\n\n### Returns\n\n- `{ metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }; spec: { description?: string; }; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }`\n\n  - `metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }`\n  - `spec: { description?: string; }`\n  - `status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'`\n\n### Example\n\n```typescript\nimport Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya();\n\nconst workspace = await client.workspaces.create({\n  metadata: { name: 'name' },\n  spec: {},\n});\n\nconsole.log(workspace);\n```",
    perLanguage: {
      typescript: {
      ...
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/cadenya/cadenya-go"\n\t"github.com/cadenya/cadenya-go/option"\n)\n\nfunc main() {\n\tclient := cadenya.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tworkspace, err := client.Workspaces.New(context.TODO(), cadenya.WorkspaceNewParams{\n\t\tMetadata: cadenya.F(cadenya.WorkspaceNewParamsMetadata{\n\t\t\tName: cadenya.F("name"),\n\t\t}),\n\t\tSpec: cadenya.F(cadenya.WorkspaceSpecParam{}),\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", workspace.Metadata)\n}\n',
      },
      ruby: {
        method: 'workspaces.create',
        example:
          'require "cadenya"\n\ncadenya = Cadenya::Client.new(api_key: "My API Key")\n\nworkspace = cadenya.workspaces.create(metadata: {name: "name"}, spec: {})\n\nputs(workspace)',
      },
      cli: {
        method: 'workspaces create',
        example:
          "cadenya workspaces create \\\n  --api-key 'My API Key' \\\n  --metadata '{name: name}' \\\n  --spec '{}'",
      },
      http: {
        example:
          'curl https://api.cadenya.com/v1/workspaces \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $CADENYA_API_KEY" \\\n    -d \'{\n          "metadata": {\n            "name": "name"\n          },\n          "spec": {}\n        }\'',
  ...
  },
  {
    ...
    stainlessPath: '(resource) workspaces > (method) get_current',
    qualified: 'client.workspaces.getCurrent',
    response:
      "{ metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }; spec: { description?: string; }; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }",
    markdown:
      "## get_current\n\n`client.workspaces.getCurrent(): { metadata: account_resource_metadata; spec: workspace_spec; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }`\n\n**get** `/v1/workspaces/current`\n\nRetrieves the workspace associated with the current API token. Useful for workspace-scoped tokens to identify which workspace they belong to.\n\n### Returns\n\n- `{ metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }; spec: { description?: string; }; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }`\n\n  - `metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }`\n  - `spec: { description?: string; }`\n  - `status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'`\n\n### Example\n\n```typescript\nimport Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya();\n\nconst workspace = await client.workspaces.getCurrent();\n\nconsole.log(workspace);\n```",
    perLanguage: {
      typescript: {
        method: 'client.workspaces.getCurrent',
        example:
          "import Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya({\n  apiKey: process.env['CADENYA_API_KEY'], // This is the default and can be omitted\n});\n\nconst workspace = await client.workspaces.getCurrent();\n\nconsole.log(workspace.metadata);",
      },
      go: {
        method: 'client.Workspaces.GetCurrent',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/cadenya/cadenya-go"\n\t"github.com/cadenya/cadenya-go/option"\n)\n\nfunc main() {\n\tclient := cadenya.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tworkspace, err := client.Workspaces.GetCurrent(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", workspace.Metadata)\n}\n',
      },
      ruby: {
        method: 'workspaces.get_current',
        example:
          'require "cadenya"\n\ncadenya = Cadenya::Client.new(api_key: "My API Key")\n\nworkspace = cadenya.workspaces.get_current\n\nputs(workspace)',
      },
      cli: {
        method: 'workspaces get_current',
        example: "cadenya workspaces get-current \\\n  --api-key 'My API Key'",
      },
      http: {
        example:
  ...
  },
  {
    ...
    description: 'Retrieves a workspace by ID from the current account.',
    ...
    response:
      "{ metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }; spec: { description?: string; }; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }",
    markdown:
      "## retrieve\n\n`client.workspaces.retrieve(id: string): { metadata: account_resource_metadata; spec: workspace_spec; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }`\n\n**get** `/v1/workspaces/{id}`\n\nRetrieves a workspace by ID from the current account.\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }; spec: { description?: string; }; status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'; }`\n\n  - `metadata: { id: string; accountId: string; name: string; profileId: string; externalId?: string; labels?: object; }`\n  - `spec: { description?: string; }`\n  - `status?: 'STATUS_ENABLED' | 'STATUS_DISABLED' | 'STATUS_ARCHIVED'`\n\n### Example\n\n```typescript\nimport Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya();\n\nconst workspace = await client.workspaces.retrieve('id');\n\nconsole.log(workspace);\n```",
    perLanguage: {
      typescript: {
      ...
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/cadenya/cadenya-go"\n\t"github.com/cadenya/cadenya-go/option"\n)\n\nfunc main() {\n\tclient := cadenya.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tworkspace, err := client.Workspaces.Get(context.TODO(), "id")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", workspace.Metadata)\n}\n',
      },
      ruby: {
        method: 'workspaces.retrieve',
        example:
          'require "cadenya"\n\ncadenya = Cadenya::Client.new(api_key: "My API Key")\n\nworkspace = cadenya.workspaces.retrieve("id")\n\nputs(workspace)',
      },
      cli: {
        method: 'workspaces retrieve',
        example: "cadenya workspaces retrieve \\\n  --api-key 'My API Key' \\\n  --id id",
      },
      http: {
        example:
          'curl https://api.cadenya.com/v1/workspaces/$ID \\\n    -H "Authorization: Bearer $CADENYA_API_KEY"',
      },
    },
  },
  {
    ...
    params: ['id: string;'],
    markdown:
      "## delete\n\n`client.workspaces.delete(id: string): void`\n\n**delete** `/v1/workspaces/{id}`\n\nArchives a workspace. This is a soft delete: the workspace is retained but any subsequent request scoped to it returns a permission error. Requires the admin role.\n\n### Parameters\n\n- `id: string`\n\n### Example\n\n```typescript\nimport Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya();\n\nawait client.workspaces.delete('id')\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        ...
        example:
          'require "cadenya"\n\ncadenya = Cadenya::Client.new(api_key: "My API Key")\n\nresult = cadenya.workspaces.delete("id")\n\nputs(result)',
      },
      cli: {
        method: 'workspaces delete',
        example: "cadenya workspaces delete \\\n  --api-key 'My API Key' \\\n  --id id",
      },
      http: {
        example:
          'curl https://api.cadenya.com/v1/workspaces/$ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $CADENYA_API_KEY"',
  ...
  },
  {
    ...
    description: 'Lists the members (actors) of a workspace. Requires the admin role.',
    stainlessPath: '(resource) workspaces.members > (method) list',
    qualified: 'client.workspaces.members.list',
    ...
    perLanguage: {
      ...
      go: {
        method: 'client.Workspaces.Members.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/cadenya/cadenya-go"\n\t"github.com/cadenya/cadenya-go/option"\n)\n\nfunc main() {\n\tclient := cadenya.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.Workspaces.Members.List(\n\t\tcontext.TODO(),\n\t\t"workspaceId",\n\t\tcadenya.WorkspaceMemberListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      ruby: {
        method: 'workspaces.members.list',
        example:
          'require "cadenya"\n\ncadenya = Cadenya::Client.new(api_key: "My API Key")\n\npage = cadenya.workspaces.members.list("workspaceId")\n\nputs(page)',
      },
      cli: {
        method: 'members list',
        example:
          "cadenya workspaces:members list \\\n  --api-key 'My API Key' \\\n  --workspace-id workspaceId",
      },
      http: {
        example:
          'curl https://api.cadenya.com/v1/workspaces/$WORKSPACE_ID/members \\\n    -H "Authorization: Bearer $CADENYA_API_KEY"',
      },
    },
  },
  {
    ...
    description:
      'Grants a profile access to the workspace by creating an actor that links the profile to the workspace. Idempotent — re-adding an active member is a no-op. Requires the admin role.',
    stainlessPath: '(resource) workspaces.members > (method) add',
    qualified: 'client.workspaces.members.add',
    params: ['workspaceId: string;', 'profileId?: string;'],
    response: '{ actorId: string; profileId: string; addedAt?: string; email?: string; name?: string; }',
    markdown:
      "## add\n\n`client.workspaces.members.add(workspaceId: string, profileId?: string): { actorId: string; profileId: string; addedAt?: string; email?: string; name?: string; }`\n\n**post** `/v1/workspaces/{workspaceId}/members`\n\nGrants a profile access to the workspace by creating an actor that links the profile to the workspace. Idempotent — re-adding an active member is a no-op. Requires the admin role.\n\n### Parameters\n\n- `workspaceId: string`\n\n- `profileId?: string`\n  The existing account profile to add to the workspace.\n\n### Returns\n\n- `{ actorId: string; profileId: string; addedAt?: string; email?: string; name?: string; }`\n  A member of a workspace: the profile granted access plus the actor row that\n links it to the workspace. Returned by member list/add operations.\n\n  - `actorId: string`\n  - `profileId: string`\n  - `addedAt?: string`\n  - `email?: string`\n  - `name?: string`\n\n### Example\n\n```typescript\nimport Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya();\n\nconst workspaceMember = await client.workspaces.members.add('workspaceId');\n\nconsole.log(workspaceMember);\n```",
    perLanguage: {
      typescript: {
        method: 'client.workspaces.members.add',
        example:
          "import Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya({\n  apiKey: process.env['CADENYA_API_KEY'], // This is the default and can be omitted\n});\n\nconst workspaceMember = await client.workspaces.members.add('workspaceId');\n\nconsole.log(workspaceMember.actorId);",
      },
      go: {
        method: 'client.Workspaces.Members.Add',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/cadenya/cadenya-go"\n\t"github.com/cadenya/cadenya-go/option"\n)\n\nfunc main() {\n\tclient := cadenya.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tworkspaceMember, err := client.Workspaces.Members.Add(\n\t\tcontext.TODO(),\n\t\t"workspaceId",\n\t\tcadenya.WorkspaceMemberAddParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", workspaceMember.ActorID)\n}\n',
      },
      ruby: {
        method: 'workspaces.members.add',
        example:
          'require "cadenya"\n\ncadenya = Cadenya::Client.new(api_key: "My API Key")\n\nworkspace_member = cadenya.workspaces.members.add("workspaceId")\n\nputs(workspace_member)',
      },
      cli: {
        method: 'members add',
        example:
          "cadenya workspaces:members add \\\n  --api-key 'My API Key' \\\n  --workspace-id workspaceId",
      },
      http: {
        example:
          "curl https://api.cadenya.com/v1/workspaces/$WORKSPACE_ID/members \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $CADENYA_API_KEY\" \\\n    -d '{}'",
  ...
  {
    name: 'remove',
    endpoint: '/v1/workspaces/{workspaceId}/members/{id}',
    httpMethod: 'delete',
    summary: 'Remove a member from a workspace',
    description:
      "Revokes a member's access to the workspace by deactivating their actor. The member is immediately cut off; the underlying profile is not deleted. Requires the admin role.",
    stainlessPath: '(resource) workspaces.members > (method) remove',
    qualified: 'client.workspaces.members.remove',
    params: ['workspaceId: string;', 'id: string;'],
    markdown:
      "## remove\n\n`client.workspaces.members.remove(workspaceId: string, id: string): void`\n\n**delete** `/v1/workspaces/{workspaceId}/members/{id}`\n\nRevokes a member's access to the workspace by deactivating their actor. The member is immediately cut off; the underlying profile is not deleted. Requires the admin role.\n\n### Parameters\n\n- `workspaceId: string`\n\n- `id: string`\n\n### Example\n\n```typescript\nimport Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya();\n\nawait client.workspaces.members.remove('id', { workspaceId: 'workspaceId' })\n```",
    perLanguage: {
      typescript: {
        method: 'client.workspaces.members.remove',
        example:
          "import Cadenya from '@cadenya/cadenya';\n\nconst client = new Cadenya({\n  apiKey: process.env['CADENYA_API_KEY'], // This is the default and can be omitted\n});\n\nawait client.workspaces.members.remove('id', { workspaceId: 'workspaceId' });",
      },
      go: {
      ...
      ruby: {
        method: 'workspaces.members.remove',
        example:
          'require "cadenya"\n\ncadenya = Cadenya::Client.new(api_key: "My API Key")\n\nresult = cadenya.workspaces.members.remove("id", workspace_id: "workspaceId")\n\nputs(result)',
      },
      cli: {
        method: 'members remove',
        example:
          "cadenya workspaces:members remove \\\n  --api-key 'My API Key' \\\n  --workspace-id workspaceId \\\n  --id id",
      },
      http: {
        example:
          'curl https://api.cadenya.com/v1/workspaces/$WORKSPACE_ID/members/$ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $CADENYA_API_KEY"',
      },
    },
  },
  {
