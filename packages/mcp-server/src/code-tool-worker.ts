...
import { Cadenya, ClientOptions } from 'cadenya';
...
const fuse = new Fuse(
  [
    ...
    'client.documentNamespaces.create',
    'client.documentNamespaces.delete',
    'client.documentNamespaces.list',
    'client.documentNamespaces.retrieve',
    'client.documentNamespaces.update',
