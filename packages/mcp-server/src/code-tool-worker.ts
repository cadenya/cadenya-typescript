...
const fuse = new Fuse(
  [
    ...
    'client.agentVariations.addAssignment',
    'client.agentVariations.addMemoryLayer',
    'client.agentVariations.create',
    'client.agentVariations.delete',
    'client.agentVariations.list',
    'client.agentVariations.removeAssignment',
    'client.agentVariations.removeMemoryLayer',
    'client.agentVariations.retrieve',
    'client.agentVariations.update',
    'client.agentVariations.updateMemoryLayer',
