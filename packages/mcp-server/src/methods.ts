...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.workspaces.getCurrent',
    fullyQualifiedName: 'workspaces.getCurrent',
    httpMethod: 'get',
    httpPath: '/v1/workspaces/current',
  },
  {
    clientCallName: 'client.workspaces.members.list',
    fullyQualifiedName: 'workspaces.members.list',
    httpMethod: 'get',
    httpPath: '/v1/workspaces/{workspaceId}/members',
  },
  {
    clientCallName: 'client.workspaces.members.add',
    fullyQualifiedName: 'workspaces.members.add',
    httpMethod: 'post',
    httpPath: '/v1/workspaces/{workspaceId}/members',
  },
  {
    clientCallName: 'client.workspaces.members.remove',
    fullyQualifiedName: 'workspaces.members.remove',
    httpMethod: 'delete',
    httpPath: '/v1/workspaces/{workspaceId}/members/{id}',
  },
