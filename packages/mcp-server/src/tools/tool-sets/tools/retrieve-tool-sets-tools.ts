...
export const metadata: Metadata = {
  ...
  operationId: 'ToolService_GetTool',
};

export const tool: Tool = {
  name: 'retrieve_tool_sets_tools',
  description:
...
export const handler = async (client: Cadenya, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.toolSets.tools.retrieve(id, body)));
};
