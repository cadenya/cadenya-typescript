...
export const metadata: Metadata = {
  ...
  operationId: 'PromptService_UpdatePrompt',
};

export const tool: Tool = {
  name: 'update_agents_prompts',
  description:
...
export const handler = async (client: Cadenya, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.agents.prompts.update(id, body)));
};
