...
export const metadata: Metadata = {
  ...
  operationId: 'PromptService_GetPrompt',
};

export const tool: Tool = {
  name: 'retrieve_agents_prompts',
  description:
...
export const handler = async (client: Cadenya, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.agents.prompts.retrieve(id, body)));
};
