...
export const metadata: Metadata = {
  ...
  operationId: 'WorkspaceSecretService_UpdateWorkspaceSecret',
};

export const tool: Tool = {
  name: 'update_workspace_secrets',
  description:
...
export const handler = async (client: Cadenya, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.workspaceSecrets.update(id, body)));
};
