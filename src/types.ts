 ...
 *  the two must be set.
 */
export type MemoryEntryCreateSpec =
 ...
 */
export type ModelSpec_Capability =
  | ModelSpec_Capability_Temperature
  | ModelSpec_Capability_TopP
  | ModelSpec_Capability_TopK
  | ModelSpec_Capability_StopSequences
  | ModelSpec_Capability_MaxOutputTokens
  | ModelSpec_Capability_Reasoning
  | ModelSpec_Capability_Caching;
 ...
 *  the variants is set.
 */
export type ObjectiveToolCallResult_ContentBlock =
 ...
 */
export type SetToolCallContentRequest_ContentBlock =
  | SetToolCallContentRequest_ContentBlock_Text
  | SetToolCallContentRequest_ContentBlock_Image
 ...
 */
export type ToolSetAdapter_ApprovalRequirementFilter =
...
export type ToolSetAdapter_OpenAPI =
 ...
 */
export type ToolSetAdapter_StringMatcher =
...
export function wireArray<T>(value: Array<T> | null | undefined, fn: (v: T) => unknown): unknown {
  return value == null ? value : value.map(fn);
}

export function wireMap<T>(value: Record<string, T> | null | undefined, fn: (v: T) => unknown): unknown {
  return value == null ? value : Object.fromEntries(Object.entries(value).map(([k, v]) => [k, fn(v)]));
}

export function wireAPIKeySpec(value: APIKeySpecParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.description !== undefined) out["description"] = value.description;
  if (value.permissions !== undefined) out["permissions"] = value.permissions;
  return out;
}

export function wireAddAgentVariationAssignmentRequest(value: AddAgentVariationAssignmentRequestParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  switch ((value as never as Record<string, unknown>)["type"]) {
...
export function wireCreateAgentVariationRequest(value: CreateAgentVariationRequestParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.metadata !== undefined) out["metadata"] = value.metadata;
  if (value.spec !== undefined) out["spec"] = value.spec;
  return out;
}

export function wireMemoryLayerSpec(value: MemoryLayerSpecParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
...
export function wireObjectiveEpisodicConfig(value: ObjectiveEpisodicConfigParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
...
export function wireRemoveAgentVariationAssignmentRequest(value: RemoveAgentVariationAssignmentRequestParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  switch ((value as never as Record<string, unknown>)["type"]) {
...
export function wireWidgetSessionSpec(value: WidgetSessionSpecParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.widgetId !== undefined) out["widgetId"] = value.widgetId;
  if (value.tenant !== undefined) out["tenant"] = value.tenant;
  if (value.subject !== undefined) out["subject"] = value.subject;
  if (value.expiresAt !== undefined) out["expiresAt"] = value.expiresAt;
  if (value.pinnedParameters !== undefined) out["pinnedParameters"] = value.pinnedParameters;
  return out;
}

export function wireAddAgentVariationAssignmentRequest_ToolId(value: AddAgentVariationAssignmentRequest_ToolIdParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.type !== undefined) out["type"] = value.type;
  if (value.toolId !== undefined) out["toolId"] = value.toolId;
  return out;
}

export function wireAddAgentVariationAssignmentRequest_ToolSetId(value: AddAgentVariationAssignmentRequest_ToolSetIdParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.type !== undefined) out["type"] = value.type;
  if (value.toolSetId !== undefined) out["toolSetId"] = value.toolSetId;
  return out;
}

export function wireAddAgentVariationAssignmentRequest_SubAgentId(value: AddAgentVariationAssignmentRequest_SubAgentIdParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.type !== undefined) out["type"] = value.type;
...
export function wireRemoveAgentVariationAssignmentRequest_ToolSetId(value: RemoveAgentVariationAssignmentRequest_ToolSetIdParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.type !== undefined) out["type"] = value.type;
  if (value.toolSetId !== undefined) out["toolSetId"] = value.toolSetId;
...
export function wireRemoveAgentVariationAssignmentRequest_SubAgentId(value: RemoveAgentVariationAssignmentRequest_SubAgentIdParam | null | undefined): unknown {
  if (value == null || typeof value !== 'object') return value;
  const out: Record<string, unknown> = {};
  if (value.type !== undefined) out["type"] = value.type;
  if (value.subAgentId !== undefined) out["subAgentId"] = value.subAgentId;
